...
async def ws_endpoint(
    ...
    try:
        if role == "player":
            ...
            print(f"   📢 Broadcast player_joined до всіх")
            ...
            ss = ServerStateSync(
                ...
                durationMs=state.get("durationMs"),
                question=question,
                scoreboard=sb,  # ✅ Завжди надсилаємо
                reveal=None,
            )
        ...
        while True:
            ...
            # 🟢 === Початок питання (host:next_question) ===
                ...
                print(f"▶️ Запуск наступного питання...")
            ...
            # 🟢 === Гравець явно приєднується (застаріле) ===
            elif t == "player:join":
        ...
        if role == "player" and player_name:
            try:
                ...
                print(f"   ⚠️ Помилка broadcast: {str(e)}")
        ...
        if player_id and role == "player":
            try:
                ...
                print(f"   🗑️ Видалено гравця з Redis")
            except Exception as e:
                print(f"   ⚠️ Помилка видалення з Redis: {str(e)}")